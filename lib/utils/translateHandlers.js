...
module.exports = function createHandlers() {
    return {
        ...
        Property: function(node, translate) {
            return node.name;
        },
        ...
        Combinator: function(node, translate) {
            return node.name;
        },

        Identifier: function(node, translate) {
            return node.name;
        },

        PseudoClass: function(node, translate) {
            return ':' + node.name;
        },

        PseudoElement: function(node, translate) {
            return '::' + node.name;
        },

        Class: function(node, translate) {
            return '.' + node.name;
        },

        Id: function(node, translate) {
            return '#' + node.name;
        },

        Hash: function(node, translate) {
            return '#' + node.value;
        },

        Dimension: function(node, translate) {
            return node.value + node.unit;
        },

        Nth: function(node, translate) {
            return node.value;
        },

        Number: function(node, translate) {
            return node.value;
        },

        String: function(node, translate) {
            return node.value;
        },

        Operator: function(node, translate) {
            return node.value;
        },

        Raw: function(node, translate) {
            return node.value;
        },

        Unknown: function(node, translate) {
            return node.value;
        },

        Percentage: function(node, translate) {
            return node.value + '%';
        },

        Space: function(node, translate) {
            return ' ';
        },

        Comment: function(node, translate) {
            return '/*' + node.value + '*/';
        }
    };
};
