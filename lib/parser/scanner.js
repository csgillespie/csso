...
var Scanner = function(source, initBlockMode, initLine, initColumn) {
    ...
    var line = typeof initLine === 'undefined' ? 1 : initLine;
    var column = typeof initColumn === 'undefined' ? 1 : initColumn;
    ...
    this.lines[sourceLength] = line;
    this.columns[sourceLength] = column;
